...
// function to create a new user - SIGN UP NEW USER
...
// function to login a user - LOG IN
...
// function that allows user to get profile when they are authenicated - GET PROFILE
export const getProfile = async (req, res) => {
   // send back user profile
   res.send(req.user);
};

// function to update an individal user by ID - UPDATE USER
...
// function to allow logged in user to delete thier own user profile - REMOVE ACCOUNT
