...
// this is the async function that help users login
...
// use a method on userSchema to set up middleware - customize behavior of mongoose model
...
userSchema.pre('save', async function (next) {
   ...
   if (user.isModified('password')) {
      // taking the plain text password and hashing it and then use the hash value to override the plain text value
...
// whenever a user is removed, this code will remove thier tasks as well.
userSchema.pre('remove', async function (next) {
   const user = this;

   // delete multiple tasks using the just owner field
